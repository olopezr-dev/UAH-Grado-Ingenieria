...
class GameView(arcade.View):
    ...
    def setup(self):
        ...
        GameView.player_sprite = PlayerSprite(":characters:Male/linkillo.png")
    ...
    def apply_damage(self, amount):
        GameView.player_sprite.take_damage(amount)

    def apply_heal(self, amount):
        GameView.player_sprite.heal(amount)

    def apply_heal_mana(self, amount):
        GameView.player_sprite.heal_mana(amount)

    def use_mana(self, amount):
        GameView.player_sprite.use_mana(amount)

    def gain_exp(self, amount):
        GameView.player_sprite.gain_exp(amount)
    ...
    def on_update(self, delta_time):
        ...
        if "blocked_doors" in map_layers:
            # Did we hit a door?
            doors_hit = arcade.check_for_collision_with_list(
                GameView.player_sprite, map_layers["blocked_doors"]
            )
            # We did!
